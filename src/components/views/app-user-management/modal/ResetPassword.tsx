...
//Schema Imports
import { resetPasswordSchema, type ResetPasswordFormValues } from '@schemas/appUserManagement'

//Component Imports
import ResetPass from '@components/modal/shared/ResetPass'

//Types import
import type { PasswordMethod, ResetPasswordProps } from '@custom-types/pages/app-user'

//Redux Imports
import { resetPassword, lastPasswordChange } from '@features/app-user/thunk'
...
const ResetPassword = (props: ResetPasswordProps) => {
  ...
  const { isResetPasswordLoading } = useSelector((state: RootState) => state.appUserManagement)
