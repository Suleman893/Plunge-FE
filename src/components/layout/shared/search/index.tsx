    ...
    <>
      {/* {isBreakpointReached || settings.layout === 'horizontal' ? (
        <IconButton onClick={() => setOpen(false)}>
          <i className='tabler-search text-[#888888] text-2xl' />
        </IconButton>
      ) : (
        <div className='flex items-center gap-2 cursor-pointer'>
          ...
          <div className='whitespace-nowrap select-none text-textDisabled text-sm'>Search here</div>
        </div>
      )} */}
      <CommandDialog open={open} onOpenChange={setOpen}>
        <div className='flex items-center justify-between border-be pli-4 plb-3 gap-2'>
          <Title hidden />
          <Description hidden />
          <i className='tabler-search text-[#888888]' />
